  ...
  if (auto structType = type.dyn_cast<spirv::StructType>()) {
    ...
    for (auto elementIndex :
      ...
      if (hasOffset) {
        ...
        offsetDecoration.memberIndex = elementIndex;
        offsetDecoration.decoration = spirv::Decoration::Offset;
        offsetDecoration.decorationValue =
            static_cast<uint32_t>(structType.getMemberOffset(elementIndex));
        offsetDecoration.hasValue = 1;
